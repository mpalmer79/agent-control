// Agent Control seed script.
//
// Loads the demo scenario described in SEED_DATA_PLAN.md into PostgreSQL. The
// data is fictional, contains no secrets, and tells the same operational story
// as the UI shell mock data: healthy agents, a problem agent with a failed
// evaluation and an open incident, a pending approval, and a rollback target.
//
// The script is idempotent: it clears existing demo rows before inserting.
...
async function clear(): Promise<void> {
  // Delete in dependency order. Safe for the demo database only.
...
async function main(): Promise<void> {
  ...
  console.log("Seed complete for organization", organization.slug, counts);
}
